  ...
  <div class="contenedor d-flex flex-column align-items-center min-vh-100 min-width">
    <nav class="container-fluid navbar navbar-expand-lg bg-light">
        <div class="container d-flex justify-content-between">
          <a class="navbar-brand" href="/biblioteca/public/home">ILoveBooks</a>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link active" href="/biblioteca/public/biblioteca">Biblioteca</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" href="/biblioteca/public/perfil">Perfil</a>
              </li>
            </ul>
          </div>
        </div>
